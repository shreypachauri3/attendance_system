...
logo_label = tk.Label(window, image=logo_img, bd=0)
...
# message = tk.Label(window, text="Thapar University" ,bg="white"  ,fg="black"  ,width=20  ,height=2,font=('Times New Roman', 25, 'bold')) 
# message.place(x=1150, y=760)

message = tk.Label(window, text="ATTENDANCE MANAGEMENT PORTAL" ,bg="white"  ,fg="black"  ,width=35  ,height=1,font=('Sitka Text Semibold', 35, 'bold underline')) 
message.place(x=320 - message.winfo_width() // 2, y=20+window.winfo_height() // 2 - message.winfo_height() // 2)

lbl = tk.Label(window, text="ENTER YOUR COLEGE ID", width=24  ,height=1  ,fg="black"  ,bg="#f0f3f9" ,font=('Sitka Text Semibold', 18, ' bold ') ) 
...
lbl = tk.Label(window, text="ENTER YOUR NAME", width=24  ,height=1  ,fg="black"  ,bg="#f0f3f9" ,font=('Sitka Text Semibold', 18, ' bold ') ) 
lbl.place(x=120-x_cord, y=320-y_cord)
...
button = tk.Button(window, text="Upload your picture", command=browse_file  ,width=25  ,height=1  ,fg="black"  ,bg="#f0f3f9" ,font=('Times New Roman', 18, ' bold ') )
button.place(x=120-x_cord, y=440-y_cord)
